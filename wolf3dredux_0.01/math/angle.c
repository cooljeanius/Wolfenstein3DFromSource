...
/*
-----------------------------------------------------------------------------
 Function: angle_interpolate -Linear interpolate between angle A and B by
								fraction 'f'.
...
-----------------------------------------------------------------------------
*/
INLINECALL float angle_interpolate( float from, float to, float fraction )
{
...
/*
-----------------------------------------------------------------------------
 Function: angle_lerp -Linear interpolate allowing for the Modulo 360 problem.
...
-----------------------------------------------------------------------------
*/
INLINECALL float angle_lerp( float from, float to, float frac )
{
	if( to - from > 180 )
	{
		to -= 360;
