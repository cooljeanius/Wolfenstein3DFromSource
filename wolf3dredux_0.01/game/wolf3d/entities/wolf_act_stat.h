...
stateinfo objstate[ NUMENEMIES ][ NUMSTATES ] =
{
	/* en_guard, */
	{
		...
		{ 1, SPR_GRD_W2_1,  8, T_Chase,	NULL, st_chase3  }, /* st_chase3, */
	...
	/* en_officer, */
	{
		...
		{1, SPR_OFC_W2_1,  8, T_Chase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_ss, */
	{
		...
		{1, SPR_SS_W2_1,  8, T_Chase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_dog, */
	{
		...
		{1, SPR_DOG_W2_1,  8, T_DogChase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_boss, */
	{
		...
		{0, SPR_BOSS_W2,  8, T_Chase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_schabbs, */
	{
		...
		{0, SPR_SCHABB_W2,  8, T_BossChase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_fake, */
	{
		...
		{0, SPR_FAKE_W2,  8, T_Fake, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_hitler, (mecha) */
	{
		...
		{0, SPR_MECHA_W2,  8, T_Chase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_hitler, */
	{
		...
		{0, SPR_HITLER_W2, 2, T_Chase, NULL, st_chase3},  /* st_chase3, */
	...
	/* en_mutant, */
	{
		...
		{1, SPR_MUT_W2_1,  8, T_Chase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_blinky, */
	{
		...
		{0, SPR_BLINKY_W2, 10, T_Ghosts, NULL, st_chase1},/* st_chase3, */
	...
	/* en_clyde, */
	{
		...
		{0, SPR_DEMO,  0, NULL, NULL, st_chase2},			/* st_chase1s, */
		{0, SPR_CLYDE_W2, 10, T_Ghosts, NULL, st_chase1},/* st_chase3, */
	...
	/* en_pinky, */
	{
		...
		{0, SPR_DEMO,  0, NULL, NULL, st_chase2},			/* st_chase1s, */
		{0, SPR_PINKY_W2, 10, T_Ghosts, NULL, st_chase1},/* st_chase3, */
	...
	/* en_inky, */
	{
		...
		{0, SPR_DEMO,  0, NULL, NULL, st_chase2},			/* st_chase1s, */
		{0, SPR_INKY_W2, 10, T_Ghosts, NULL, st_chase1},/* st_chase3, */
	...
	/* en_gretel, */
	{
		...
		{0, SPR_GRETEL_W2,  8, T_Chase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_gift, */
	{
		...
		{0, SPR_GIFT_W2,  8, T_BossChase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_fat, */
	{
		...
		{0, SPR_FAT_W2,  8, T_BossChase, NULL, st_chase3}, /* st_chase3, */
...
/* --- Spear of destiny! */
	...
	/* en_spectre, */
	{
		...
		ST_INFO_NULL, /* st_chase1s, */
		{0, SPR_SPECTRE_W2, 10, T_Ghosts, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_angel, */
	{
		...
		{0, SPR_ANGEL_W2,  8, T_BossChase,	NULL, st_chase3}, /* st_chase3, */
	...
	/* en_trans, */
	{
		...
		{0, SPR_TRANS_W2,  8, T_Chase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_uber, */
	{
		...
		{0, SPR_UBER_W2,  8, T_Chase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_will, */
	{
		...
		{0, SPR_WILL_W2,  8, T_BossChase, NULL, st_chase3}, /* st_chase3, */
	...
	/* en_death */
	{
		...
		{0, SPR_DEATH_W2,  8, T_BossChase, NULL, st_chase3}, /* st_chase3, */
