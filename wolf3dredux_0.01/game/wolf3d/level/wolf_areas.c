...
PRIVATE W8			areaconnect[ NUMAREAS ][ NUMAREAS ];
PUBLIC  _boolean	areabyplayer[ NUMAREAS ];
...
/*
-----------------------------------------------------------------------------
 Function: Areas_DisconnectAreas
