...
#ifdef __ADLIB_H__
# warning "adlib.h was already included, including it again will have no effect."
#endif /* __ADLIB_H__ */
#include "adlib.h"
#ifndef __ADLIB_H__
# warning "failed to actually include adlib.h"
#endif /* !__ADLIB_H__ */
#include "fmopl.h"
...
/*
-----------------------------------------------------------------------------
 Function: ADLIB_Shutdown() -Shutdown adlib hardware.
...
-----------------------------------------------------------------------------
*/
/* same thing as with ADLIB_Init() regarding its prototype... */
...
#define ADLIB_MUSIC_BYPS	(ADLIB_MUSIC_SPEED*2) /* bytes per second (16bit) */
